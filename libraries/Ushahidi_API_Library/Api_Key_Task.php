...
class Api_Key_Task extends Task_Base
{
    ...
    protected function parse_json()
    {
    	...
    	if( (!isset($data_array[Task_Base::ERROR_INDEX])) || 
    		...
    		(!isset($data_array[Task_Base::PAYLOAD_INDEX])) )
    		{
    			return new Task_Response_Base("U1", "Unable to parse JSON string. use getJson() on the task object to see what was returned");	
    		}
    	elseif(
    		(!isset($data_array[Task_Base::PAYLOAD_INDEX][Task_Base::SERVICES_INDEX])) ||
    		(!isset($data_array[Task_Base::PAYLOAD_INDEX][Task_Base::SERVICES_INDEX][0])) ||
    		(!isset($data_array[Task_Base::PAYLOAD_INDEX][Task_Base::SERVICES_INDEX][0][Task_Base::SERVICE_INDEX])) ||
    		(!isset($data_array[Task_Base::PAYLOAD_INDEX][Task_Base::SERVICES_INDEX][0][Task_Base::SERVICE_INDEX][Task_Base::ID_INDEX])) ||
    		(!isset($data_array[Task_Base::PAYLOAD_INDEX][Task_Base::SERVICES_INDEX][0][Task_Base::SERVICE_INDEX][Task_Base::API_KEY_INDEX]))
    	)
    	{
    	...
    	$response = new Api_Key_Response($data_array[Task_Base::ERROR_INDEX][Task_Base::ERROR_CODE_INDEX], 
    		$data_array[Task_Base::ERROR_INDEX][Task_Base::ERROR_MESSAGE_INDEX],
    		$data_array[Task_Base::PAYLOAD_INDEX][Task_Base::SERVICES_INDEX][0][Task_Base::SERVICE_INDEX][Task_Base::ID_INDEX],
    		$data_array[Task_Base::PAYLOAD_INDEX][Task_Base::SERVICES_INDEX][0][Task_Base::SERVICE_INDEX][Task_Base::API_KEY_INDEX]);
