 ...
 */
 ...
 class Incidents_Task_Parameter extends Task_Parameter_Base 
 {
	...
	/**
	 * 
	 * Set the "by" parameter use the Incidents_Bys class to set this field
	 * @param consts from Incidents_Bys $x
	 */
	...
	public function setSort($x) { $this->sort = $x; } 
 	...
 	public function get_query_string()
 	{
 		...
 		switch($this->by)
 		{
 			...
 			case Incidents_Bys::BY_CATEGORY_ID:
 			case Incidents_Bys::BY_INCIDENT_ID:
 			case Incidents_Bys::BY_LOCATION_ID:
 			case Incidents_Bys::INCIDENTS_SINCE_ID:
 				$queryStr["id"] = $this->id;
 				break;
 				
 			case Incidents_Bys::BY_CATEGORY_NAME:
 			case Incidents_Bys::BY_LOCATION_NAME:
 				$queryStr["name"] = $this->name;
 				break;
 			
 			case Incidents_Bys::BY_BOUNDS:
 				if($this->c != null)
 				{
 					$queryStr["c"] = $this->c;
 				}
